...
std::pair<size_t, size_t> NEH_WPT::taillard_best_insertion(const std::vector<size_t> &sequence, size_t pos) {
...
void NEH_WPT::second_step(std::vector<size_t> phi, Solution &s) {
